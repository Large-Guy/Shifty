...
namespace Shifty {
    ...
    public:
        ...
        static T easeInOutExpo(T t) {
            return t == (T) 0 ? (T) 0 : t == (T) 1 ? (T) 1 : t < (T) 0.5 ? std::pow((T) 2, (T) 20 * t - (T) 10) / (T) 2
                                                                         :
        ...
        static T easeInOutCirc(T t) {
            return t < (T) 0.5 ? ((T) 1 - std::sqrt((T) 1 - t * t)) / (T) 2 :
        ...
        static T easeInOutBack(T t) {
            ...
            return t < (T) 0.5 ? (std::pow((T) 2 * t, (T) 2) * ((c2 + (T) 1) * (T) 2 * t - c2)) / (T) 2 :
        ...
        static T easeInElastic(T t) {
            ...
            return t == (T) 0 ? (T) 0 : t == (T) 1 ? (T) 1 : -std::pow((T) 2, (T) 10 * t - (T) 10) *
        ...
        static T easeInOutElastic(T t) {
            ...
            return t == (T) 0 ? (T) 0 :
                   t == (T) 1 ? (T) 1 :
                   t < (T) 0.5 ? -(std::pow((T) 2, (T) 20 * t - (T) 10) * std::sin(((T) 20 * t - 11.125f) * c4)) / (T) 2
                               :
                   (std::pow((T) 2, -(T) 20 * t + (T) 10) * std::sin(((T) 20 * t - 11.125f) * c4)) / (T) 2 + (T) 1;
        }
    };
