...
void EditKeydown::process(const OnKeyPress& input)
{
    ...
    case SDLK_BACKSPACE:
        {
            Entity::multiEach<Focus, Text, Edit>([&](Focus& focus, Text& text, Edit& edit)
            {
                if (edit.highlighting)
                {
    ...
    case SDLK_RIGHT:
        {
            Entity::multiEach<Focus, Text, Edit>([&](Focus& focus, const Text& text, Edit& edit)
            {
                if (shift)
                {
                    EditShared::select(edit);
    ...
    case SDLK_V:
        {
            if (ctrl)
            {
                Entity::multiEach<Focus, Text, Edit>([&](Focus& focus, Text& text, Edit& edit)
                {
                    ...
                    {
                        EditShared::handleTextInput(OnTextInput{input.handler, std::string(clipboardText)});
...
{
    Entity::find<InputHandler>().textInput = false; //TODO: This is a bit of a sketchy way to do this
    Entity::multiEach<Focus, Edit>([](Focus& focus, Edit& edit)
    {
...
{
    Entity::multiEach<Focus, Text, Edit, RenderTransform>(
        [&](Focus& focus, Text& text, Edit& edit, const RenderTransform& renderTransform)
        {
